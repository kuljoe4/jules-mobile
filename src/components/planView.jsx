 ...
 */
export const PlanView = memo(({ activities, session, apiKey, onApprove, onSendFeedback, busy, allSessions = EMPTY_ARR, activitiesMap = EMPTY_OBJ }) => {
  ...
  // OPTIMIZATION (Bolt): Use direct ISO timestamp string comparison to bypass parseDateMs loops,
  // and reference-stable EMPTY_ARR / EMPTY_OBJ default props to preserve React.memo equality.
